...
//
// ⚠️ Каждая реплика читается самостоятельно: Ксении может не быть, и её две
// реплики выпадут. Ни одно сообщение не должно опираться на её текст.
...
const CURRENT_MESSAGES = [
...

  {
    ...
    at: 0.2,
    text:
      'Дочитала первую часть. Рассказ Мышкина про смертную казнь — перечитала три раза. Не ожидала, что в романе про доброго князя будет самое точное, что я читала про страх.',
    reactions: { '🔥': ['marina'] },
  },
  {
    who: 'marina',
    at: 0.23,
    text:
      'Сцена, где Настасья Филипповна бросает пачку денег в камин. И Ганя, который в итоге не полез, — вот это меня добило больше всего. Он же почти полез.',
  },
  {
    who: 'olya',
    at: 0.26,
