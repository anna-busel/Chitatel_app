...
const ARCHIVE_MESSAGES = [
  ...
  },
  {
    ...
    replyTo: 'tyazhelo',
    text:
      'Оля, она и должна даваться тяжело. Стейнбек не развлекает — он показывает, как нужда и усталость меняют людей, и не отводит взгляд. То, что вы дважды откладывали и вс蔞-таки дочитали, — это и есть настоящее чтение.',
    reactions: { '❤️': ['olya'] },
  },
  {
    who: 'darya',
